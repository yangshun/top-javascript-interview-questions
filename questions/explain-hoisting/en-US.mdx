...
## Hoisting
How to Answer In interview: Hoisting is a JavaScript mechanism where variable and function declarations are moved, or "hoisted," to the top of their containing scope during the compile phase.
